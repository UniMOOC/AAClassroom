...
THIRD_PARTY_LIBS = [
    ...
    _Library('six-1.9.0.zip', relative_path='six-1.9.0'),
    _Library('oauth2client-1.4.5.zip', relative_path='oauth2client-1.4.5'),
    _Library('pyparsing-1.5.7.zip'),
    _Library('python-dateutil-1.5.zip', relative_path='python-dateutil-1.5'),
]
