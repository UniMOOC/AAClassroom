...
class Unit13(object):
    ...
    def __init__(self):
        ...
        self.unit_parent = None
        self.certificate = None
        self.badge = None
        self.docs = None
        self.min_score = None
        self.required_asms = None
        # UM_CODE_END
...
class CourseModel13(object):
    ...
    def update_unit(self, unit):
        ...
        # UM_CODE_START
        existing_unit.unit_image = unit.unit_image
        existing_unit.unit_parent = unit.unit_parent
        existing_unit.certificate = unit.certificate
        existing_unit.badge = unit.badge
        existing_unit.docs = unit.docs
        existing_unit.min_score = unit.min_score
        existing_unit.required_asms = unit.required_asms
        # UM_CODE_END
...
class Course(object):
    ...
    def create_base_settings_schema(cls):
        ...
        # UM_CODE_START
        course_opts.add_property(schema_fields.SchemaField(
            'course:open_docs', 'UM Always open docs', 'boolean',
            description='All the documents open at the start of the course '
